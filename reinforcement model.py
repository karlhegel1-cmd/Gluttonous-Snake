...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    train_parser.add_argument("--max-steps", type=int, default=1800)
    ...
    eval_parser.add_argument("--max-steps", type=int, default=1800)
    ...
    eval_parser.add_argument("--reward-shaping", action="store_true")
